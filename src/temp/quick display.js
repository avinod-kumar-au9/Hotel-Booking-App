    ...
    if (this.state.data) {
      return this.state.data.map((user) => {
        return (
          ...
          <Link key={user._id} to={`/list/${user.trip}`} className="row sinitem">
        ...
        return <img className="loadingimg" src="https://flevix.com/wp-content/uploads/2020/01/Bounce-Bar-Preloader-1.gif" />
    }
  };
      ...
      <div className="quicksea">
        ...
        <div className="container">
          <div className="row justify-content-md-center">
            <div className="col col-lg-6">{this.searchcall()}</div>
          </div>
        </div>
      </div>
    );
